<template>
  <div class="min-h-screen flex flex-col">
    <nav class="bg-hmps-blue">
      ...
      >
        ...
        <ul class="text-white uppercase flex">
          ...
          <li class="text-base sm:text-2xl cursor-pointer">About Us</li>
        </ul>
      </div>
    </nav>
    ...
    please use class below for your content:
    max-w-screen-lg px-4 sm:px-6
    -->
    <div class="mb-auto">
      <slot></slot>
    </div>
    ...
    <footer
      class="sm:text-2xl font-bold text-hmps-blue uppercase round-lg rounded-t py-12 before:bg-pink-100"
    >
      <div class="max-w-screen-lg px-4 sm:px-6 mx-auto">
        ...
        <div class="border-t flex py-4">
          <ul class="mr-32">
            <li class="mb-8">Articles</li>
            <li class="mb-8">News</li>
            <li>About Us</li>
          </ul>
          <ul>
