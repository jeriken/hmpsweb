<template>
  <div class="min-h-screen">
    ...
    <div class="min-h-screen flex flex-col">
      ...
      <footer
        class="sm:text-2xl font-bold text-hmps-blue uppercase round-lg rounded-t sm:py-6 py-2 before:bg-pink-100"
      >
        <div class="max-w-screen-lg px-4 sm:px-6 mx-auto">
          ...
          <div class="border-t flex py-4">
            ...
            <ul>
              <li class="sm:mb-8 mb-4">
                <a
                  href="https://www.youtube.com/channel/UC6OQMY-welm6KyOHUndCHjw/featured"
